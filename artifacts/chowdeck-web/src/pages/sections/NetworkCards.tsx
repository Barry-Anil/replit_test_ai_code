...
import { Store, Bike, Users, Handshake, ArrowRight } from "lucide-react";
...
export function NetworkCards() {
  const cards = [
    ...
    },
    {
      ...
      bg: "bg-blue-50",
      title: "Start selling",
      desc: "Set up your storefront in minutes, manage your menu, and start receiving orders from thousands of hungry customers nearby.",
      link: "#",
      label: "storefront"
    },
    {
    ...
    <section id="company" className="py-24 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <h2 className="text-4xl md:text-5xl font-black max-w-sm leading-tight">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {cards.map((card, i) => (
            ...
            >
              ...
              <a
                href={card.link}
                className="inline-flex items-center text-primary font-bold gap-2 group-hover:gap-3 transition-all"
